        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleTemplates_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SpecialSchedules_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorSchedules_ScheduleTemplates_ScheduleTemplateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSchedules_ScheduleTemplateId",
                table: "DoctorSchedules",
                column: "ScheduleTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleTemplates_DoctorId",
                table: "ScheduleTemplates",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_SpecialSchedules_DoctorId_Date",
